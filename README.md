...
Projeto referente à disciplina **Estruturas de Dados Básicas I (EDB 1)**, no curso de **Tecnologia da Informação** da **Universidade Federal do Rio Grande do Norte (UFRN)**, em **dupla**, com o objetivo de aplicar, na prática, conceitos fundamentais de estruturas de dados por meio de uma simulação computacional.
